    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🎖 DEPLOY YOURS 🎖', url=f'https://t.me/joinchat/21-626z8Zko3YWU1')
                    ]
                    ]
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
                InlineKeyboardButton("Search Here", url=f'https://t.me/MM_Mallu_Movies_Group')
                ],[
...
async def bot_info(bot, message):
    buttons = [
        [
            ...
            InlineKeyboardButton('Deploy Video', url=f'https://t.me/joinchat/21-626z8Zko3YWU1')
        ]
        ]
