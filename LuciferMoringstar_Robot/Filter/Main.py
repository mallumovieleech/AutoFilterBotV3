...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        elif query.data == "How to Download":
            await query.answer()
    else:
        await query.answer("**EMPURAN** 👉Request ലഭിക്കുന്നതിനായി സാധാരണ പോലെ Button ഉപയോഗിക്കുക...,
 👉ശേഷം ചാനലുകൾക്ക് പകരം ബോട്ടിലേക്കാണ് നിങ്ങൾ എത്തിച്ചേരുക..,
 👉അവിടെ "START" അമർത്തുമ്പോൾ നിങ്ങൾക്ക് movie files ലഭിക്കും.OK👀",show_alert=True)
